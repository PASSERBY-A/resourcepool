...
public class CmdbCacheServiceEhcacheImpl implements CmdbCacheService {
	private static Logger log = Logger.getLogger(CmdbCacheServiceEhcacheImpl.class);
	...
	// Map<relationTypeName,relationNode>
	...
	public void setCiTypes(Map<String, Node> ciTypes) {
		CmdbCacheServiceEhcacheImpl.ciTypes = ciTypes;
	}
	...
	public void setRelationTypes(Map<String, RelationNode> relationTypes) {
		CmdbCacheServiceEhcacheImpl.relationTypes = relationTypes;
	}
	...
	// }
	//
	// public void setViews(Map<String, ViewDefine> views) {
	// CmdbCacheServiceImpl.views = views;
	// }
	...
	public void setRelationIds(Map<String, List<String>> relationIds) {
		CmdbCacheServiceEhcacheImpl.relationIds = relationIds;
	}
	...
	public void setNodes(Map<String, Node> nodes) {
		CmdbCacheServiceEhcacheImpl.nodes = nodes;
	}
	...
	public void setRelations(Map<String, RelationNode> relations) {
		CmdbCacheServiceEhcacheImpl.relations = relations;
	}
	...
	@Override
	public String getNodeId_name(String typeName) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public String getRelationId_name(String typeName) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public RelationNode getRelations(String typeId) {
		// TODO Auto-generated method stub
		return null;
	}
