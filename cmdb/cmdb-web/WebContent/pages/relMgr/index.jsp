...
<body>
	<div class="ui-layout-west">
		...
		<!-- 
		<a
				id="property" href="#" title="property" onclick="return false;"><img
				src="images/edit/comment.delete.16.png" alt="property" /></a>
		 -->
	...
	<div id="basicProperty-form" title="关系基础属性">
...
<!--				<table id="metaclass-attr" width = "600"></table>
	...
	<iframe id = "ciListFrame" src="../relMgr/attribute.jsp"  width="100%" height="100%" frameborder="0" scrolling="yes"></iframe>	 	
	</div>
</body></HTML>