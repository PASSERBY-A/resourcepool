...
<body>
	<div class="ui-layout-west">
		<div class="flip">
			<a id="addLeaf" href="#" title="添加配置关系"
				onclick="return false;"> 
				<img src="images/edit/comment.add.16.png" alt="add leaf node" />
			</a> 
			<a
				id="edit" href="#" title="编辑配置关系" onclick="return false;"><img
				src="images/edit/comment.edit.16.png" alt="edit name" />
			</a> 
			<a
				id="remove" href="#" title="移除关系" onclick="return false;"><img
...
<div id="basicProperty-form" title="类基础属性">
...
<!--				<table id="metaclass-attr" width = "600"></table>
	...
	<iframe id = "ciListFrame" src="../relTypeMgr/attribute.jsp"  width="100%" height="100%" frameborder="0" scrolling="no"></iframe>	 	
	</div>
</body></HTML>