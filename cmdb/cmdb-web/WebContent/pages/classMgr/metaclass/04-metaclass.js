...
//	alert(treeNode.tId + ", " + treeNode.name +  ", " + treeNode.typeName +  ", " + treeNode.id );
	$("#ciListFrame").attr("src","../classMgr/attribute.jsp?typeName=" + treeNode.typeName );
...
var treeNode = nodes[0];
	...
	//$("#openXXXIframe").attr("src","../classMgr/ciType.jsp?typeName="+treeNode.typeName);
...
//						});
					  ...
					  var paraId = returnNode.id;
					  zTree.selectNode(zTree.getNodeByParam("id", paraId, treeNode));
					  $("#ciListFrame").attr("src","../classMgr/attribute.jsp?typeName=" + returnNode.typeName );
					  //var newNode = zTree.getNodesByParam("id", returnNode.id, treeNode);
...
//			  var result = data.result;
			  ...
			  $( "#properyId" ).attr("value",data.id);
			  $( "#propertyName" ).attr("value",data.name);
			  $( "#propertyLabel" ).attr("value",data.label);
			  $( "#icon" ).attr("value",data.icon);
			  $( "#derivedFrom" ).attr("value",data.derivedFrom);
			  $( "#parentId" ).attr("value",data.parentId);
			  $( "#path" ).attr("value",data.path);
