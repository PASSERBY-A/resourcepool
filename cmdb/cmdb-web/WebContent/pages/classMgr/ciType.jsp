...
<div id="main">
   <form action="#" method="post">
	<div id="wizard">
		<ul id="status">
			<li class="active"><strong>1.</strong>CI类型信息</li>
			<li><strong>2.</strong>CI类型属性</li>
			<li><strong>3.</strong>完成</li>
		</ul>

		<div class="items">
			<div class="page">
               <h3>CI类型信息<br/><em></em></h3>
               <p><label>显示名称：</label><input type="text" class="input" id="label" name="label" /></p>
               <p><label>CI类型名称：</label><input type="input" class="input" id="name" name="name" /></p>
			...
			<div class="page">
               ...
               <div id="ciAtrributeDiv" class="easyui-window" hidden="true" closed="true" modal="true" title="标题" style="width:500px;height:250px;">
			...
			<div class="page">
               ...
               <div id="targetNodeDiv" class="easyui-window" hidden="true" closed="true" modal="true" title="标题" style="width:500px;height:250px;">
...
$(function(){
	...
	$("#goToCiAttribute").click(function(){
		...
		$("#ciAttribute").attr("src","../ciMgr/ciSelected.jsp?isSource=true");
	});
