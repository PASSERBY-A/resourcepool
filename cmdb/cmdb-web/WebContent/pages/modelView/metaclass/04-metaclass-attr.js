...
//    rowList: [10,20,30],
    loadonce: false,
    colNames:['主机名', '属性一', '属性二'],
    colModel:[
           {name:'host', width:140, align:'left', editable:true},
           {name:'att_1', width:140, align:'left', editable:true},
           {name:'att_2', width:140, align:'left', editable:true}
    ],
