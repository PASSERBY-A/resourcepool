...
function SelectorView(id){
	...
	this._init = function(){
		...
		str += '<table class="selector_table" height = "350">\n';
		str += '<tr>';
		...
		str += "</td>\n";
		str += '<td align="center" style="vertical-align: middle;">';
		str += '<input type="button" id="butSelected" value=">>" onclick="document.getElementById(\'' + this.id + '\').view.select()" />';
		str += '<input type="button" id="butUnselected" value="<<" onclick="document.getElementById(\'' + this.id + '\').view.unselect()" />';
		str += '</td>';
