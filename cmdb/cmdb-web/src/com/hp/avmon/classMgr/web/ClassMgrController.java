...
import com.hp.avmon.classMgr.service.ClassMgrService;
...
public class ClassMgrController {
	...
	@Autowired
	private ClassMgrService classMgrService;
	...
	public void delClass(HttpServletRequest request,PrintWriter writer) {
		...
		String json = classMgrService.delClass(typeName);
        writer.write(json);
        writer.flush();
        writer.close();
	}
