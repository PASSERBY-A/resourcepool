                      ...
                      <div class="left BasePerBoxilo-center-back">
                        <div class="left marginR6">
                          ...
                          <div class="left margin10">
                            ...
                            <div class="Extra-Main" style="display:none" id="caseCurC">℃</div>
                            <div class="Number-title" style="display:none" id="caseCurTemp">当前温度</div>
                            <div class="marginT10">
                          <!--   <b id="tempalarm" class="Icon_status_red Icon16 Pos-R left"></b>
                            <span id="tempalarmText" class="title left darkblue marginL10 marginT2" style="width:40px"></span> -->
                             <b id="tempalarm" ></b>
                            <span id="tempalarmText" class="title left darkblue marginL10 marginT2" style="width:40px"></span>
                            </div>
                          </div> 
                        ...
                        <div class="left marginR15">
                         ...
                         <!--  <div class="left margin10">
                            <div class=" marginL25"><b id="VRMStatus" class="Icon_status_green Icon16 Pos-R left"></b><span id="VRMStatusText" class="title left darkblue marginL10 marginT2" style="width:40px"></span></div>
                          </div>  -->
                          <div class="left margin10">
                            <div class=" marginL25"><b id="VRMStatus" ></b><span id="VRMStatusText" class="title left darkblue marginL10 marginT2" style="width:40px"></span></div>
                          </div> 
                        </div>
                         <div class="left marginR15">
                          <div class="margin10"><b class="Pos-R Icon_Fan Icon16 marginT8"></b><span class="marginL8 fB">风扇整体状态</span></div>
                           <div class="left margin10">
                            <div class=" marginL25"><b id="FANStatus" ></b><span id="FANStatusText" class="title left darkblue marginL10 marginT2" style="width:40px"></span></div>
                          </div> 
                         <!--  <div class="left margin10">
                            <div class=" marginL25"><b id="FANStatus" class="Icon_status_green Icon16 Pos-R left"></b><span id="FANStatusText" class="title left darkblue marginL10 marginT2" style="width:40px"></span></div>
                          </div>  -->
                        </div>
                         <div class="left marginR15">
                          <div class="margin10"><b class="Pos-R Icon_Temperature Icon16 marginT8"></b><span class="marginL8 fB">温度整体状态</span></div>
                         <!--   <div class="left margin10">
                            <div class=" marginL25"><b id="TEMPStatus" class="Icon_status_green Icon16 Pos-R left"></b><span id="TEMPStatusText" class="title left darkblue marginL10 marginT2" style="width:40px"></span></div>
                          </div>  -->
                          
                          <div class="left margin10">
                            <div class=" marginL25"><b id="TEMPStatus" ></b><span id="TEMPStatusText" class="title left darkblue marginL10 marginT2" style="width:40px"></span></div>
                          </div> 
                        </div>
                      </div>
            	 ...
            	 if(document.readyState == "complete"){ //当页面加载状态为完全结束时进入
                     ...
                     $("#overviewtable").find("td").each(function(){ 
                    	/*  if($(this).attr("class")=="TD_default"){
                    		...
                    		//ipmi dashboard
               $.getJSON("${ctx}/pages/dashboard/impiHost/getBiosList?moId="+moId,
       					function(data) {
         		    $("#currentTemp1").text(data[0].cpuTemp);
         	     });
        		 
        		 $.getJSON("${ctx}/pages/dashboard/impiHost/getCpuComm?moId="+moId,
        					function(data) {
                  ...
                  $.getJSON("${ctx}/pages/dashboard/impiHost/getIpmiHostCpuTemp?moId="+moId,
        					function(data) {
        			 $("#currentTemp1").text(data[0].cpuTemp);
          			
          	     });
        		 $.getJSON("${ctx}/pages/dashboard/impiHost/getIpmiHostPluginTemp?moId="+moId,
     					function(data) {
        			 $("#dimm_temp").text(data[0].dimmTemp);
       			
       	         });
        		 $.getJSON("${ctx}/pages/dashboard/impiHost/getMemList?moId="+moId,
     					function(data) {
       			     
       			
       	         });
        		 
        		 $.getJSON("${ctx}/pages/dashboard/impiHost/getIpmiHostOther?moId="+moId,
      					function(data) {
        			 ...
        			 $("#min_current_value").text(data[0].minCurrentValue);
                    		 ...
                    		 //ipmi sel count
                    		 $.getJSON("${ctx}/pages/dashboard/impiHost/getSelCount?moId="+moId,
                  					function(data) {
        		...
        		//机箱
        		 $.getJSON("${ctx}/pages/dashboard/iloHost/getCaseList?moId="+moId,
        			 ...
        			 if(data.basicData[6].VAL=="ok"){
        			    ...
        			    console.log(data.basicData[1].VAL);
        			    ...
        			    if(data.basicData[0].VAL=="yes"){
       			        ...
       			        }else if(data.basicData[0].VAL=="no"){
       			  ...
       			  if(data.length==0){
       				 $htmlp=  $('<p class="f12px table-right"><span class="marginR4">共</span><span class="darkblue marginR4">0</span><span>个Power</span></p>');  
       				  ...
       				  for(var j=0;j<data.length;j++){
       					/*  $htmlli=$( '<li> <div class="left marginR2"><b class="Pos-R Icon_Power Icon16"></b></div><div class="left"> <span class="fB">'+data[j].power+'</span>'+
      							  ...
      							  '<div class="left marginT10 marginL10 "><span class="title left darkblue marginL10 marginT2" style="width:60px">工作状态</span>'+
      				 ...
      				 */
       					  $htmlli=$( '<li> <div class="left marginR2"><b class="Pos-R Icon_Power Icon16"></b></div><div class="left"> <span class="fB">'+data[j].power+'</span>'+
       							  ...
       							  '<div class="Number-title">当前温度</div> <div class="marginT10 left"><b id="powerHot'+(j+1)+'" class="Icon_status_red Icon16 Pos-R left"></b><span id="powerIsHot'+(j+1)+'" class="title left darkblue marginL10 marginT2" style="width:40px">过热</span></div></div>'+
       							  '<div class="left marginT10 marginL10 ">'+
       							  ' <div class="blank10"></div> </div> </div> </div><div class="blank0"></div></li> ' ); 
...
/*                  
		   ...
		   //sel data
		   var seltypeurl = "${ctx}/pages/dashboard/impiHost/getSelTypeList?moId="+moId;
           var seltypesource =
            {
                datatype: "json",
                datafields: [
			...
			var selsource = {
					...
					id : 'id',
					url : '${ctx}/pages/dashboard/impiHost/getSelList?moId='+moId
				};
			function loadSelGridData(selsource){
			 ...
			 $("#querysel").click(function() {
					...
					selsource.url='${ctx}/pages/dashboard/impiHost/getSelList?moId='+moId+"&selcontent="+encodeURI(encodeURI(selcontent))
        	 ...
        	 function loadNestGrid(moId){
              ...
              function loadGridData(source,alarmGridId) {
        	   ...
        	   $('#jqxgrid').on('rowdoubleclick', function (event) {
        		 ...
        		 moId=rowdata.MO_ID;
        		 $("#ipmiforhostName").text(rowdata.hostName);
        		 ...
        		 //ipmi dashboard
        		 $.getJSON("${ctx}/pages/dashboard/impiHost/getIpmiHostBasicInfo?moId="+moId,
      					function(data) {
            ...
            $(".PerformanceNavBox").click(function(){
            	 ...
            	 hostsource.url = "${ctx}/pages/dashboard/iloHost/getIloPerformanceList?typeId="+typeId+"&bizName="+encodeURI(encodeURI(item2.label));
     		     loadGrid(hostsource);
     		    var url='${ctx}/pages/dashboard/iloHost/getIloOverViewPerformanceList?typeId='+typeId+"&bizName="+encodeURI(encodeURI(item2.label));
               	 loadHostOverView(url);
            ...
            if($.getUrlParam('moId')!=null){
                url = "${ctx}/pages/dashboard/iloHost/getIloPerformanceList?bizName="+encodeURI(encodeURI(item2.label))+'&moId='+$.getUrlParam('moId');
            }
            //
             url = "${ctx}/pages/dashboard/iloHost/getIloPerformanceList?bizName="+encodeURI(encodeURI(item2.label));
     			// prepare the data
     			  var hostsource = {
     				datatype : "json",
     				datafields : [ {
     			 ...
     			 if($.getUrlParam('biz')==""){
  		            ...
  		            hostsource.url = "${ctx}/pages/dashboard/iloHost/getIloPerformanceList?bizName=others"+"&moId="+$.getUrlParam('moId');
  				    loadGrid(hostsource);
  				    var url='${ctx}/pages/dashboard/iloHost/getIloOverViewPerformanceList?bizName=others'+"&moId="+$.getUrlParam('moId');
  			        loadHostOverView(url);
	    	       ...
	    	       for(var i=0;i<items.length;i++){
	    	    	 if(decodeURI($.getUrlParam('biz'))==items[i].label){
      	    	    ...
      	    	    hostsource.url = "${ctx}/pages/dashboard/iloHost/getIloPerformanceList?bizName="+$.getUrlParam('biz')+"&moId="+$.getUrlParam('moId');
      	    	    loadGrid(hostsource);
 				    var url='${ctx}/pages/dashboard/iloHost/getIloOverViewPerformanceList?bizName='+$.getUrlParam('biz')+"&moId="+$.getUrlParam('moId');
 				    loadHostOverView(url);
      	      }
        ...
        function loadHostOverView(url){
       	if(url==undefined){
       		if($.getUrlParam('moId')==null){
       			...
       			url='${ctx}/pages/dashboard/iloHost/getIloOverViewPerformanceList?bizName='+encodeURI(encodeURI(item.label))+'&moId='+$.getUrlParam('moId');
