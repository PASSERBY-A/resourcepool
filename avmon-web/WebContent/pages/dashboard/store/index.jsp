...
<head>
	...
	<script>
		...
		function reloadModule(moId){
		    ...
		    setTimeout(function(){
		    	Ext.store.application.refreshByLoad();
		    },10);
...
<body onLoad="afterLoad();">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/extjs420g/bootstrap.js"></script>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/dashboard/store/app.js"></script>
	</div>
</body>
</html>