...
<style>
		...
		#grapharea { position: absolute; float: left; /*margin-left: 2em;*/ }

		#graphcontainer { position: relative; width: 28px; height: 48px; overflow: hidden; }
...
<%
	...
	if (kpi == null||kpi == "") {
		kpi = "0";
		pageContext.setAttribute("kpi", kpi);
	}
...
<body onLoad="loadColumn();">
	        ...
	        <div id="graphcontainer" >
		        <img src="images/graphbackground.png" id="graphbackground" width="28" height="48" alt="" />
		        <img src="" id="graphbar" width="28" height="48" alt="" />
		        <img src="images/graphforeground.png" id="graphforeground" width="28" height="48" alt="" />
	        </div>
        </div>
</body>
</html>