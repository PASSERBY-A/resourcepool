...
<head>
    ...
    <style type="text/css">
        ...
        .errorlog{font-size: 14px; color: #EE4000; } 
	...
	<script>
		...
		function afterLoad(){
			Ext.mainEngine={};
			Ext.mainEngine.moId='<%=mo%>';
			
			Ext.mainEngine.isLevel0_b=1;
			Ext.mainEngine.isLevel1_b=1;
			Ext.mainEngine.isLevel2_b=1;
			Ext.mainEngine.isLevel3_b=1;
			Ext.mainEngine.isLevel4_b=1;
			Ext.mainEngine.isHist_alarm_b=0;
			Ext.mainEngine.isNewalarm_b=0;
			Ext.mainEngine.isMyalarm_b=0;
			
			Ext.mainEngine.levelStr='';

			//阈值需要
			Ext.mainEngineThreshold={};
			Ext.mainEngineThreshold.mem=''; 
			Ext.mainEngineThreshold.swap=''; 
			Ext.mainEngineThreshold.cpu='';
		
			Ext.mainEngineThreshold.file=new Array();
			Ext.mainEngineThreshold.disk=new Array();
		
		
			Ext.mainEngineThreshold.syslog='';
			Ext.mainEngineThreshold.maillog='';
			Ext.mainEngineThreshold.rclog='';
			Ext.mainEngineThreshold.mplog='';
