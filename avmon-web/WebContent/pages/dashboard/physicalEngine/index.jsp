...
<head>
	...
	<script>
		function afterLoad(){
			Ext.physicalEngine={};
			Ext.physicalEngine.moId='<%=mo%>';
			
			Ext.physicalEngine.isLevel0_b=1;
			Ext.physicalEngine.isLevel1_b=1;
			Ext.physicalEngine.isLevel2_b=1;
			Ext.physicalEngine.isLevel3_b=1;
			Ext.physicalEngine.isLevel4_b=1;
			Ext.physicalEngine.isHist_alarm_b=0;
			Ext.physicalEngine.isNewalarm_b=0;
			Ext.physicalEngine.isMyalarm_b=0;
			
			Ext.physicalEngine.levelStr='';
