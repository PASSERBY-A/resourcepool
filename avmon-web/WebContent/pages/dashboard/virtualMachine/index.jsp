...
<head>
	...
	<script>
		function afterLoad(){
			Ext.virtualMachine={};
			Ext.virtualMachine.moId='<%=mo%>';
			
			Ext.virtualMachine.isLevel0_b=1;
			Ext.virtualMachine.isLevel1_b=1;
			Ext.virtualMachine.isLevel2_b=1;
			Ext.virtualMachine.isLevel3_b=1;
			Ext.virtualMachine.isLevel4_b=1;
			Ext.virtualMachine.isHist_alarm_b=0;
			Ext.virtualMachine.isNewalarm_b=0;
			Ext.virtualMachine.isMyalarm_b=0;
			
			Ext.virtualMachine.levelStr='';
