  ...
  <div id="ShowTitleMenu" style="display:none">
            ...
            <div id="sidebar" style="width:140px;">
	             <div class="Tab_category_Overview"> 
		              <ul id="datacenter">
			              ...
			              <li id="HARDWARE" class="Tab_category_Overview_active"><a href="classManager"><b class="Icon24 Overview_icon_ZYSL"></b><span>资源实例</span></a></li>              
   ...
   <!-- end -->
	...
	$(document).ready(function() {  
        $('.content').html('<iframe id = "ciListFrame" src="http://16.159.216.146:8888/cmdb-web/pages/ciMgr/index.jsp"  width="100%" height="100%" frameborder="0" scrolling="yes"/>');
	});
