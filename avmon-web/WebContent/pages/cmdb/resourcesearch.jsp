  ...
  <div id="ShowTitleMenu" style="display:none">
	...
	<div id="container">
            ...
            <div id="sidebar" style="width:140px;">
             <div class="Tab_category_Overview"> 
              ...
              <li id="MIDDLEWARE" class="Tab_category_Overview_active" ><a href="resourceSearch"><b class="Icon24 Overview_icon_ZYCX"></b><span>资源查询 </span></a></li>
              </ul>
              </div>
            </div>
   ...
   <!-- end -->
	...
	$(document).ready(function() {  
		 $('.content').html('<iframe id = "ciListFrame" src="http://16.159.216.146:8888/cmdb-web/pages/searchMgr/index.jsp"  width="100%" height="100%" frameborder="0" scrolling="yes"/>');
