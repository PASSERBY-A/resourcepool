  ...
  <div id="ShowTitleMenu" style="display:none">
	...
	<div id="container">
            ...
            <div id="sidebar" style="width:140px;">
             <div class="Tab_category_Overview"> 
              ...
              <li id="DATABASE" class="Tab_category_Overview_active"><a href="classModelManager"><b class="Icon24 Overview_icon_ZYMX"></b><span>资源模型</span></a></li>
   ...
   <!-- end -->
	...
	$(document).ready(function() {  
		 ...
		 $('.content').html('<iframe id = "ciListFrame" src="http://16.159.216.146:8888/cmdb-web/pages/classMgr/index.jsp"  width="100%" height="100%" frameborder="0" scrolling="yes"/>');
	});
