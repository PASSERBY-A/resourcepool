...
Ext.define('CFG.view.TdAvmonKpiInfoAutoCloseRuleGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.TdAvmonKpiInfoAutoCloseRuleGrid',
    //自定义属性
    pup:false,
    noPup:true,
    autoCloseRuleForm:null,
    pupKpiWin:null,
    initComponent: function() {
        Ext.apply(this, {
            ...
            iconCls: 'icon-grid',
            border: false,
            autoCloseRuleForm:this.autoCloseRuleForm,
            ...
            selectKPI:function(){
			    ...
			    if(selection.length == 0||selection.length >1){
			    	...
			    	this.autoCloseRuleForm.down("#kpi").setValue(selection[0].data.kpi_code);
