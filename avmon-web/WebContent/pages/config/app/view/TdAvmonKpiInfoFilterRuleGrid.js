...
Ext.define('CFG.view.TdAvmonKpiInfoFilterRuleGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.TdAvmonKpiInfoFilterRuleGrid',
    //自定义属性
    pup:false,
    noPup:true,
    filterRuleForm:null,
    ...
    initComponent: function() {
        Ext.apply(this, {
            ...
            iconCls: 'icon-grid',
            border: false,
            filterRuleForm:this.filterRuleForm,
            ...
            selectKPI:function(){
			    ...
			    if(selection.length == 0||selection.length >1){
			    	...
			    	this.filterRuleForm.down("#kpi").setValue(selection[0].data.kpi_code);
