...
'Ext.selection.CheckboxModel', 'CFG.view.TdAvmonKpiInfoMergeRuleGrid' ]);
var gridStore = Ext.create('CFG.store.TdAvmonMergeRuleGridStore');
var pupKpiGridPanel = Ext.create('CFG.view.TdAvmonKpiInfoMergeRuleGrid', {
  pup : true,
  noPup : false
});
...
var editForm = Ext.create('Ext.form.Panel', {
  ...
  buttonAlign : 'center',
  xtype : 'filedset',
  url : 'saveUpdateAlarmMergeRuleInfo',
  ...
  items : [ {
    ...
    fieldLabel : avmon.config.performMergeTimeWindowMinute,
    name : 'merge_time_window',
    allowBlank : false
  }, {
...
pupKpiGridPanel.mergeRuleForm = editForm;
...
Ext.define('CFG.view.TdAvmonMergeRuleGrid', {
  extend : 'Ext.grid.Panel',
  alias : 'widget.TdAvmonMergeRuleGrid',
  initComponent : function() {
    Ext.apply(this, {
      id : 'TdAvmonMergeRule_grid',
      title : avmon.config.alarmMergerRules,
      iconCls : 'icon-grid',
      border : false,
      columns : [ {
        text : 'Id',
        ...
        text : avmon.config.performMergeTimeWindowMinute,
        width : 150,
        sortable : true,
        dataIndex : 'merge_time_window'
      }, {
            ...
            items : [
                {
                  ...
                  handler : function() {
                    ...
                    editForm.getForm().findField("merge_time_window").setValue(
                        "0");
                      ...
                      Ext.MessageBox.confirm(avmon.common.reminder,
                          avmon.config.whetherToDelete, function(btn) {
                            if (btn == "yes") {
                              ...
                              Ext.Ajax.request({
                                url : 'deleteAlarmMergeRuleByIds?ids='
                                    + ids.join(','),
