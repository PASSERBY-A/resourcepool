...
Ext.define('CFG.view.TdAvmonKpiInfoUpgradeRuleGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.TdAvmonKpiInfoUpgradeRuleGrid',
    //自定义属性
    pup:false,
    noPup:true,
    upgradeRuleForm:null,
    pupKpiWin:null,
    initComponent: function() {
        Ext.apply(this, {
            ...
            iconCls: 'icon-grid',
            border: false,
            upgradeRuleForm:this.upgradeRuleForm,
            ...
            selectKPI:function(){
			    ...
			    if(selection.length == 0||selection.length >1){
			    	...
			    	this.upgradeRuleForm.down("#kpi").setValue(selection[0].data.kpi_code);
