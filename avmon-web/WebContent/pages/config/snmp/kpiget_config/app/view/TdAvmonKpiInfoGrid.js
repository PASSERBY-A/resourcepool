...
var editForm = Ext.create('Ext.form.Panel', {
    ...
    items: [
		...
		,{
	        fieldLabel: avmon.config.oidname,
	        name: 'kpi_name',
	        maxLength:100,
	        allowBlank: false
	    }
...
Ext.define('CFG.view.TdAvmonKpiInfoGrid', {
    ...
    initComponent: function() {
        Ext.apply(this, {
            ...
            title: avmon.modules.kpi_getConfiguration,
            iconCls: 'icon-grid',
            border: false,
    		threholdForm:this.threholdForm,
...
//				,{
//	                text: avmon.config.whetherComputationalKPI,
//	                width: 100,
//	                sortable: true,
//	                dataIndex: 'iscalc',
//		            renderer:function(data, metadata, record, rowIndex, columnIndex, store) { 
//						var data = record.data ; 
//						var iscalc = data.iscalc; 
//						if(iscalc==0){
//							return "否";
//						}else if(iscalc==1){
//							return "是";
...
//	            }
//				,{
//	                text: avmon.config.calculationMethod,
//	                width: 100,
//	                sortable: true,
...
//	            }
            ...
            selectKPI:function(){
			    ...
			    if(selection.length == 0||selection.length >1){ 
			    	...
			    	this.threholdForm.down("#kpi").setValue(selection[0].data.kpi_code);
			    	this.threholdForm.down("#kpiName").setValue(selection[0].data.caption);
			    	this.pupKpiWin.hide();
			    }
            },
            dockedItems: [{
