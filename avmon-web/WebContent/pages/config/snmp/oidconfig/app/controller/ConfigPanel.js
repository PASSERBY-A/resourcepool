...
Ext.define('app.controller.ConfigPanel', {
    ...
    onBtnSavePropClick: function(button, e, eOpts) {
        ...
        Ext.Ajax.request({
            ...
            success: function(response, opts) {
                ...
                Ext.example.msg('Done', avmon.config.monitorSaved);
            },
    ...
    onBtnPauseAgentClick: function(button, e, eOpts) {
        ...
        Ext.Ajax.request({
            ...
            params: {mo:moId},
            success: function(response, opts) {
                Ext.getCmp("agentStatus").setValue(avmon.config.suspend);
                Ext.example.msg('Done', avmon.config.agentSuspended);
            },
            failure: function(response, opts) {
                alert('error');
            }
    ...
    onBtnStartAgentClick: function(button, e, eOpts) {
        ...
        Ext.Ajax.request({
            ...
            params: {mo:moId},
            success: function(response, opts) {
                Ext.getCmp("agentStatus").setValue(avmon.config.restoreRun);
                Ext.example.msg('Done', avmon.config.agentSetRestoreRun);
            },
            failure: function(response, opts) {
                alert('error');
            }
