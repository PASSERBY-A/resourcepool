...
Ext.define('app.controller.MenuTree', {
    ...
    onBtnSelectMoTypeWindowOkClick: function(button, e, eOpts) {
        ...
        var instanceNumbers =button.up("window").down("form").getForm().findField('instanceNums').getValue();
        ...
        Ext.Ajax.request({
            url: 'createMo',
            params: {mo:moId,caption:caption,moType:typeId,agentId:agentId,businessType:businessType,instanceNumbers:instanceNumbers},
