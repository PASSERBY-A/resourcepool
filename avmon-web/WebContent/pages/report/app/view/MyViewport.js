...
Ext.define('MyApp.view.MyViewport', {
                ...
                items: [
                    {
                		...
                		" <div class=\"MainTitle f28px LineH12\" style=\"font-family: \'Microsoft yahei\',\'微软雅黑\',\'Lato\', Helvetica,Tahoma,Verdana,Arial,sans-serif \">报表查询</div>"
                    }
                ]
            },
                {
                    ...
                    listeners: {
                        select: {
                            fn: me.onReportMenuTreeSelect,
                            scope: me
                        },
                        afterlayout: {
                            fn: me.onReportMenuTreeAfterLayout,
                            scope: me
                        }
                    }
                },
    ...
    onReportMenuTreeSelect: function(rowmodel, record, index, eOpts) {
        Ext.getCmp('reportContent').body.update('<iframe scrolling="auto" frameborder="0" width="100%" height="100%" src="'+record.get("url")+'"></iframe>');
    },

    onReportMenuTreeAfterLayout: function(container, layout, eOpts) {
        var tree=Ext.getCmp("reportMenuTree");
