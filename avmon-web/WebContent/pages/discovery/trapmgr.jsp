...
<%--              <li id="scan" class="moudleSelecter"><a href="${ctx}/discovery/deviceScan">设备扫描</a></li> --%>
             ...
             <li id="mib" class="moudleSelecter"><a href="#">TRAP管理</a></li> 
                 <ul class="Tab_categoryAuto_sub">
                    <li class="Tab_categoryAuto_active moudleSelecter"><a href="${ctx}/discovery/trapmgr">告警规则配置</a></li>
                    <li><a href="${ctx}/trap/traprulemgr">规则管理</a></li>              
                 </ul>
<%--              <li id="trap" class="Tab_categoryAuto_active"><a href="${ctx}/discovery/trapmgr">TRAP管理</a></li>     --%>
<%--              <li id="trap" class="moudleSelecter"><a href="${ctx}/trap/traprulemgr">TRAP规则管理</a></li> --%>
             </ul>
             </div>
      ...
      ================================================== -->       
          <div class="content">
         <div class="AutoSearchMainNav"><a href="#" title="Go to Home"><i class="icon-home"></i> TRAP告警规则配置</a></div>
              <div class="NavResource">
        <div class="left marginR8">
            <div class="left LineH30 paddingR10">是否配置规则</div>
            <div class="left marginR20" id='jqxWidget'></div>
...
//         },
        ...
        id: 'id',
        url: '${ctx}/trap/trapList?flagType=2'
    };
    	...
    	if(checkFlag){
    		$.ajax({
     		   ...
     		   success:function(data){
     		       ...
     		       source.url='${ctx}/trap/trapList?flagType='+selectIndex;
