...
String  webURL="http://16.189.135.148:8080/avmon-web/";
String  ziyuanchiURL = "http://16.189.135.148:8888/resourcepool-web"; 
String	accountresourceURL = "http://localhost:8888/resourcepool-web/"
													+"api.action?command=accountresource&response=json&"
													+"listAll=true&cmsz=yes&jsoncallback=callback";
   ...
   <!-- end -->
		...
		<%
				...
				if(b)
				{
					...
					<div style="margin-top: 15px;height: 314px;padding-top: 1px;width: 645px;background-image:url('${ctx}/resources/images/ziyuanchi650X454.png');margin-left: 5px;" onmousedown="javascript:window.location.href='<%=ziyuanchiURL%>'">  
				...
				<div class="panorama-section">
                        ...
                        <div class="tile-column-span-2">
                           ...
                           <%}else{ %>
                              <a onclick="alarmCenter(<%=menuMap.get("ALARM_CENTER_MODULE")%>)" id="alarmCenter" class="tile wide imagetext wideimage bg-color-gray" href="#">
                              <img src="${ctx}/resources/images/Gray_BG.png">
                              <div class="textover-wrapper bg-color-gray">
                                 <div class="text2 w45px" style="margin-top: 6px; margin-left:3px;"><B class="circle bg-color-gray-2"></B>0</div>
                                 <div class="text2 w45px" style="margin-top: 6px; margin-left:3px;"><B class="circle bg-color-gray-2"></B>0</div>
                                 <div class="text2 w45px" style="margin-top: 6px; margin-left:3px;"><B class="circle bg-color-gray-2"></B>0</div>
                                 <div class="text2 w45px" style="margin-top: 6px; margin-left:3px;"><B class="circle bg-color-gray-2"></B>0</div>
                                 <div class="text2 w45px" style="margin-top: 6px; margin-left:3px;"><B class="circle bg-color-gray-2"></B>0</div>
                          ...
                          <img src="${ctx}/resources/images/zdfx150X150.png">
                            ...
                            <%}else{ %>
                             <a onclick="discover(<%=menuMap.get("DISCOVERY_MODULE")%>)" id="discover" class="tile square image bg-color-gray" href="#">
                          <img src="${ctx}/resources/images/Gary_bg_150X150.png">
                              <div class="textover-wrapper  bg-color-gray">
                                 <div class="text2">自动发现</div>
                              </div>
                           </a> 
                          ...
                          <img src="${ctx}/resources/images/NetworkPhoto.png">
                            ...
                            <%}else{ %>
                            <a onclick="network(<%=menuMap.get("NETWORK_MODULE")%>)"  id="network" class="tile square image  bg-color-gray" href="#">
                          <img src="${ctx}/resources/images/Gary_bg_150X150.png">
                              <div class="textover-wrapper  bg-color-gray">
                              <img src="${ctx}/resources/images/Network24X24.png">
                                 <div class="text2">简单网络管理</div>
                          ...
                          <img src="${ctx}/resources/images/bs150X150.png">
                           ...
                           <%}else{ %>    
                            <a onclick="agent(<%=menuMap.get("AGENT_MODULE")%>)" class="tile square image  bg-color-gray" href="#">
                          <img src="${ctx}/resources/images/Gary_bg_150X150.png">
                              <div class="textover-wrapper  bg-color-gray">
                              <img src="${ctx}/resources/images/bs24.png">
                                 <div class="text2">Agent管理</div>
                          ...
                          <img src="${ctx}/resources/images/pzgl150X150.png">
                           ...
                           <%}else{ %>    
                             ...
                             <a onclick="config(<%=menuMap.get("CONFIG_MODULE")%>)" class="tile square image  bg-color-gray" href="#">
                          <img src="${ctx}/resources/images/Gary_bg_150X150.png">
                              <div class="textover-wrapper  bg-color-gray">
                                 <div class="text2">监控配置</div>
                              </div>
                        ...
                        <div class="tile-column-span-2">
                         ...
                         <%if(menuMap.get("PERFORMANCE_MODULE").equals(0)){%>
                          ...
                          <%}else{ %>     
                           <a onclick="performance(<%=menuMap.get("PERFORMANCE_MODULE")%>)" class="tile wide imagetext wideimage  bg-color-gray" href="#">
                              <img src="${ctx}/resources/images/Gray_BG.png">
                              <div class="textover-wrapper  bg-color-gray">
                              <img src="${ctx}/resources/images/storage24X24.png">
                                 <div class="text2">性能管理</div>
                         ...
                         <a class="tile square image bg-color-bluelight" href="${ctx}/report/index">
                          <img src="${ctx}/resources/images/List150X150.png">
                            ...
                            <%}else{ %>     
                            <a onclick="report(<%=menuMap.get("REPORT_MODULE")%>)" class="tile square image bg-color-gray" href="#">
                          <img src="${ctx}/resources/images/Gary_bg_150X150.png">
                              <div class="textover-wrapper  bg-color-gray">                           
                                 <div class="text2">报表查询</div>
                              </div>
                         ...
                         <%if(menuMap.get("PERFORMANCE_ANALYZE_MODULE").equals(0)){%>
                          ...
                          <img src="${ctx}/resources/images/performanceCenter2.png">
                           ...
                           <a onclick="performanceAnalyze(<%=menuMap.get("PERFORMANCE_ANALYZE_MODULE")%>)" class="tile square image  bg-color-gray" href="#">
                          <img src="${ctx}/resources/images/Gary_bg_150X150.png">
                              <div class="textover-wrapper  bg-color-gray">
                              <img src="${ctx}/resources/images/ALL-ICON-white.png">
                                 <div class="text2">性能分析</div>
                          ...
                          <img src="${ctx}/resources/images/Resource150X150.png">
                            ...
                            <%}else{ %>   
                             <a onclick="resource(<%=menuMap.get("RESOURCE_MODULE")%>)" class="tile square image  bg-color-gray" href="#">
                          <img src="${ctx}/resources/images/Gary_bg_150X150.png">
                              <div class="textover-wrapper  bg-color-gray">
                                 <div class="text2">资源管理</div>
                              </div>
                          ...
                          <img src="${ctx}/resources/images/SyS2150X150.png">
                           ...
                           <%}else{ %>   
                            ...
                            <a onclick="system(<%=menuMap.get("SYSTEM_MODULE")%>);" class="tile square image  bg-color-gray" href="#">
                             <img src="${ctx}/resources/images/Gary_bg_150X150.png">
                              <div class="textover-wrapper bg-color-gray">
                             <img src="${ctx}/resources/images/System-ICON-white.png"> 
                                 <div class="text2">系统管理</div>
				...
				<div class="panorama-section">
                        ...
                        <div class="tile-column-span-4">
                           <a class="tile wide imagetext wideimage bg-color-purple" style="width:630px; height:310px;" onmousedown="javascript:window.location.href='<%=ziyuanchiURL%>'">
                              ...
                              <div class="textover-wrapper transparent" style="width:630px; height:50px; padding:30px 20px;">
                                 ...
                                 <div class="blank10"></div>
                                 <div class="f28px" style="padding-left:16px;" id="vmstopedcount"></div>
                                 </div>
                                 <div class="left marginR40" style="width:170px">
                                 <div class="circle bg-color-blue left" style="margin-top:4px;"></div>
                                 <div class="left f18px" style=" padding-left:16px;">总实例</div>
                                 <div class="blank10"></div>
                                 <div class="f28px" style="padding-left:16px;" id="xunjicount"></div>
                                 </div>
                               </div>
                           </a>
