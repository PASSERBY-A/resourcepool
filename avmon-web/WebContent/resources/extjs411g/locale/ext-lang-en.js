...
avmon.alarm.devicename = 'Device Name';
avmon.alarm.hostname = 'Host Name';
avmon.alarm.ipaddress = 'IP Address';
...
avmon.alarm.alarmStartTime = 'Alarm Starting Time';
avmon.alarm.hour = 'Hour';
avmon.alarm.minute = 'Minute';
...
avmon.alarm.alarmTime = 'Alarm Occurrence Time';
avmon.alarm.accepter = 'Receiver';
avmon.alarm.alarmLevel = 'Alarm Severity';
...
avmon.config.reportAttachment = 'Whether to Send an Attachment';
avmon.config.reportAttachmentType = 'Attachment Format';
avmon.config.reportAttachment = 'Whether to Send an Attachment';
avmon.config.reportAttachmentType = 'Attachment Format';
...
avmon.equipmentCenter.objectNumber = 'Object Number';
...
avmon.modules.savePasswordInLocal = 'Save your password locally';
avmon.modules.licenseRegister = 'License Registration';
...
avmon.modules.initialRegistrationCode ='Initial Registration Code';
...
avmon.modules.alarmMonitoring = 'Alarm Monitoring';
avmon.modules.realtimePerformance = 'Real-time Performance';
avmon.modules.analysisPerformance = 'Performance Analysis';
avmon.modules.realTime = 'Real-time Status';
avmon.modules.queryAndReport = 'Query and Report';
avmon.modules.resourceManagement ='Resource Management';
avmon.modules.configurationManagement = 'Configuration Management';
avmon.modules.deploymentManagement = 'Deployment Management';
avmon.modules.systemManagement = 'System Management';
