...
@Controller
@RequestMapping("/getconfigkpiCompare/*")
public class GetConfigKpiCompareController {
	
	private static final Log logger = LogFactory.getLog(GetConfigKpiCompareController.class);
