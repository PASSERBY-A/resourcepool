package com.hp.avmon.oidmanage.service;
...
@Service
public class OidmanageService {
    
    private static final Logger logger = LoggerFactory.getLogger(OidmanageService.class);
