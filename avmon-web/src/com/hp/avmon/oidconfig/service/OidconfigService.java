package com.hp.avmon.oidconfig.service;
...
@Service
public class OidconfigService {
    
    private static final Logger logger = LoggerFactory.getLogger(OidconfigService.class);
