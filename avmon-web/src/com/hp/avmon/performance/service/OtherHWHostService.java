 ...
 */
@Service
public class OtherHWHostService {
	private static final Log logger = LogFactory.getLog(OtherHWHostService.class);
	...
	/* 	String productName = bundle.getString("productName");
	 ...
	 /*	String systemRom = bundle.getString("cpuType");
	    ...
	    public List getOtherHWPerformanceList(HttpServletRequest request) {
			...
			if(bizName.equals("others")){
				 sqlString=SqlManager.getSql(PerformanceService.class,"getOtherHWPerformanceOtherDataList"); 
				 sql=String.format(sqlString,where);
			}else{
				sqlString=SqlManager.getSql(PerformanceService.class,"getOtherHWPerformanceDataList");
				sql=String.format(sqlString,whereString,where);
			}
	...
	/*		String where = "";
		...
		public int getOtherHWPerformanceListCount(HttpServletRequest request) {
			String bizName = request.getParameter("bizName");
			String queryIP = request.getParameter("queryIP");
			/*String typeId = request.getParameter("typeId");
			if (typeId == null) {
			...
			whereString=" attr.value ='"+bizName+"' ";
			if(bizName.equals("others")){
				 sqlString=SqlManager.getSql(PerformanceService.class,"getOtherHWPerformanceOtherDataListCount"); 
				 sql=String.format(sqlString,where);
			}else{
				sqlString=SqlManager.getSql(PerformanceService.class,"getOtherHWPerformanceDataListCount");
				sql=String.format(sqlString,whereString,where);
			}
		...
		public List getOtherHWOverViewPerformanceList(HttpServletRequest request) {
			...
			if(bizName.equals("others")){
				 sqlString=SqlManager.getSql(PerformanceService.class,"getOtherHWOverViewPerformanceOtherDataList");
				 sql=String.format(sqlString,where);
			}else{
				 sqlString=SqlManager.getSql(PerformanceService.class,"getOtherHWOverViewPerformanceDataList");
				 sql=String.format(sqlString,whereString,where);
			}
