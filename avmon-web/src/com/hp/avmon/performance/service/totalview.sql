SELECT a.biz as "biz",
       ...
       a.hostitemcount as "hostitemcount",
       a.storeitemcount as "storeitemcount",
       a.dbitemcount as "dbitemcount",
       a.middleitemcount as "middleitemcount",
       a.veitemcount as "veitemcount",
       a.networkitemcount as "networkitemcount",
       a.hardwareitemcount as "hardwareitemcount",
        a.hardwareitemothercount as "hardwareitemothercount",
       
       a.hostkpi1 as "hostkpi1",
       a.storekpi1 as "storekpi1",
       a.dbkpi1 as "dbkpi1",
       a.middlekpi1 as "middlekpi1",
       a.vekpi1 as "vekpi1",
       a.networkkpi1 as "networkkpi1",
       a.hardwarekpi1 as "hardwarekpi1",
       a.hardwareotherkpi1 as "hardwareotherkpi1",
  ...
  FROM (SELECT a.biz,
               ...
               100 - hardwarelevel2alarmcount * 0.5 -
               hardwarelevel3alarmcount - hardwarelevel4alarmcount * 1.5 AS hardwarekpi2,
          ...
          FROM (SELECT a.biz,
                       ...
                       COUNT(DISTINCT CASE
                               WHEN ((substr(a.type_id ,10)<>'HP' and substr(a.type_id,10)<>'DELL') 
                                   and substr(a.type_id,0,8)='HARDWARE') THEN
                                a.mo_id
                               ELSE
                                NULL
                      ...
                      SUM(CASE
                             WHEN ((substr(a.type_id ,10)<>'HP' and substr(a.type_id,10)<>'DELL') 
                                   and substr(a.type_id,0,8)='HARDWARE') AND
                                  b.current_grade = 2 THEN
                              1
                             ELSE
                              0
