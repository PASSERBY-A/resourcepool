...
@TableAnnotation(tableName="td_avmon_kpi_info")
public class TdAvmonKpiInfoBean {
	...
	@FieldAnnotation(fieldName = "type_Id", fieldType = FieldType.STRING, pk = false)
	private String type_Id;
	
	@FieldAnnotation(fieldName = "comment_sql", fieldType = FieldType.STRING, pk = false)
	private String comment_sql;
	...
	public String getComment_sql() {
		return comment_sql;
	}

	public void setComment_sql(String comment_sql) {
		this.comment_sql = comment_sql;
	}
