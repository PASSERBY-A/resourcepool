...
@Service("accountLimitAttributeValueManager")
public class AccountLimitAttributeValueManagerImpl extends
		GenericCloudServerManagerImpl implements ProvisionAttributeValueManager {
	
	/**域*/
	private String EXTERNAL_DOMAINID ="domainId";
	...
	public Map<String, Object> getExtval(String attributeName, String sessionkey, Map<String, Object[]> valueParam) {
		...
		if(EXTERNAL_DOMAINID.equalsIgnoreCase(attributeName)){//domainId
