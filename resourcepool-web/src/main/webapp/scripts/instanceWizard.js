...
(function($, cloudStack) {
    ...
    cloudStack.instanceWizard = {
            ...
            function(args) {
                ...
                if (selectedZoneObj.networktype == "Advanced") { //Advanced zone. Show network list.
                    ...
                    if (args.initArgs.pluginForm != null && args.initArgs.pluginForm.name == "vpcTierInstanceWizard") { //from VPC Tier chart
                     ...
                     // $networkStep.find("#from_vpc_tier").text("tier " + args.context.networks[0].name); //sz
        ...
        action: function(args) {
            ...
            //apply-time-length add by@ma
            array1.push("&apply-time-length=" + args.data.size[0]);
            /**
             *not use resourcePoolId
             */
           // array1.push("&resourcePoolId=" + args.data.poolid);
            ...
            if (args.data.diskofferingid != null && args.data.diskofferingid != "0") {
                ...
                if (selectedDiskOfferingObj.iscustomized == true){
                    array1.push("&diskSize=" + args.data.size[1]); //edit by @ma args.data.size -->args.data.size[1]
                }
                /*else{
                	 array1.push("&diskSize=" + selectedDiskOfferingObj.disksize);
                }*/
            }
             ...
             * added by steven
             */
           /* var applyReason=args.data.applyReason;
            if (applyReason != null && applyReason.length > 0) {
                array1.push("&applyReason=" + applyReason);
            }*/
            /**
             * added by steven
             * 新增applyreson为空的校验
             */
            if($(".applyReason textarea:last").hasClass("error")){
           ...
           // alert(array1.join(""));
            $.ajax({
            	/**
            	 * updated by steven
            	 * deployVirtualMachine改为saveOrder
            	 */
                url: createURL("saveOrder" + array1.join("")),
                dataType: "json",
                type:'post',
                data:{workOrderType:5,
                 	cmsz:'yes',
                 	status:1,
