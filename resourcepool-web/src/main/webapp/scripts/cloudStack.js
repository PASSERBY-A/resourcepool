...
(function(cloudStack, $) {
    $.extend(cloudStack, {
        ...
        sectionPreFilter: function(args) {
            ...
            if (isAdmin()) {
                //sections = ["dashboard", "instanceMenu","instances","physicsInstances","resourceMenu", "storage", "network", "templates", "accounts", "domains", "events", "system", "global-settings", "configuration", "projects", "regions", "affinityGroups","workOrders"];
//            	sections = ["dashboard", "instanceMenu","instances","physicsInstances","workOrders","resourceMenu", "storage", 
//            	            "network", "templates","system", "configuration","systemMenu","accounts", "domains", "regions","projects", "affinityGroups","global-settings","logMenu","events"];
            	sections = ["dashboard", "instances","workOrders","resourceMenu", "storage", 
            	            "network", "templates","system", "configuration","systemMenu","accounts", "domains", "regions","projects", "affinityGroups","global-settings","logMenu","events","logs","statisticMenu", "resourceStatistics","workOrderReport"];
            } else if (isDomainAdmin()) {
                sections = ["dashboard","instances","resourceMenu","storage", "network", "templates", "systemMenu","accounts", "domains","projects", "regions", "affinityGroups","workOrders","logMenu","events"];
            } else if (g_userProjectsEnabled) {

                sections = ["dashboard","instances","resourceMenu","storage", "network", "templates","systemMenu", "accounts",  "projects", "regions", "affinityGroups","workOrders","logMenu","events"];
            } else { //normal user
                sections = ["dashboard","instances","resourceMenu","storage", "network", "templates",  "systemMenu","accounts",  "regions", "affinityGroups","workOrders","logMenu","events"];
            }
            ...
            loginAction: function(args) {
                ...
                $.ajax({
                    ...
                    success: function(json) {
                        ...
                        //alert(createURL("listCapabilities"));
                        $.ajax({
                            url: createURL("listCapabilities"),
                            dataType: "json",
                            async: false,
