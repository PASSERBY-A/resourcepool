...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="css/avmon.css" />
    ...
    <body>
        ...
        <div id="template">
                    ...
                    <div class="steps">
                        ...
                        <div class="step setup" wizard-step-id="setup">
                            <div class="content">
                                ...
                                <!-- The apply time length   add by@ma-->
                         	<div class="section custom-size custom-disk-size apply-time-length" style="display: block;">
                         			<!--  <h3>选择申请时长</h3>  -->
                                     <label>申请时长</label> 
                                    <!-- Slider -->
                                    <label class="size min"><span></span> 月</label>
                                    <div class="slider custom-size ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all"><a href="#" class="ui-slider-handle ui-state-default ui-corner-all" style="left: 0%;"></a></div>
                                    <label class="size max"><span></span> 月</label>

                                    <input type="text"  name="size" class="required digits valid">
                                    <label class="size">月</label>
                            </div>
                        ...
                        <div class="step review" wizard-step-id="review">
                            ...
                            <div class="content">
								...
								<!--@ma added  最后一步加上申请时长和申请理由 -->
								<div class="select odd">
									<div class="name">
										<span>申请时长</span>
									</div>
									<div class="value">
                                            <span wizard-field="apply-time-length"></span>
                                        </div>
                                 	<div class="edit">
                                            <a href="1"><fmt:message key="label.edit"/></a>
                                    </div>
								</div>
								<div class="select applyReason">
									<div class="name">
										<span>申请理由(必填)</span>
									</div>
									<div class="value">
										<textarea name="applyReason" class="required"></textarea>
									</div>
								</div>
							</div>
                            </div>
            ...
            <div class="dashboard admin">
                ...
                <!-- Capacity / stats --> <!-- liqiang add -->
                <div class="dashboard-container head" style="width:98%;"   >
                    <div class="top">
                        <div class="title">
                            <span></span>
                        </div>
        ...
        <script type="text/javascript" src="scripts/workOrder.js?t=<%=now%>"></script>
        ...
        <!-- seconde development add -->
        <script type="text/javascript" src="scripts/physicsInstance.js?t=<%=now%>"></script>
		<script type="text/javascript" src="scripts/menu.js?t=<%=now%>"></script>
		<script type="text/javascript" src="scripts/workOrder.js?t=<%=now%>"></script>
		<script type="text/javascript" src="scripts/workOrderReport.js?t=<%=now%>"></script>
		<script type="text/javascript" src="scripts/resourceStatistics.js?t=<%=now%>"></script>
		<script type="text/javascript" src="scripts/logs.js?t=<%=now%>"></script>
        <!-- Plugin/module API -->
		...
		function pageLoadCompleteCallback()
		{
			var haslogo =<%=haslogo%>;
			
			var testlogo1='<div id="header" class="nologo"><div class="controls nologo"><div class="button notifications"><div class="total"><span>0</span></div><span>通知</span></div><div class="button view-switcher"><div class="select default-view active"><span class="icon">&nbsp;</span>默认视图</div><div class="select project-view"><span class="icon">&nbsp;</span>项目视图</div></div><div class="project-switcher"><label>Project:</label><select><option value="-1">Default view</option><option value="eecea899-8fbe-477b-a6a6-aa24c9852662">申请项目测试04</option><option value="15189f0b-c28d-48c3-a861-8d6fb34f551f">测试2</option><option value="19381977-ea6b-488d-945b-62e289e9c9a0">测试项目</option></select></div><div class="region-switcher" title="Select region"><span class="icon">&nbsp;</span><span class="title" title=""></span></div><div class="region-selector" style="display: none;"><div class="top-arrow"></div><h2>区域</h2><ul><li><span>Local</span></li></ul><div class="buttons"><div class="button close"><span>关闭</span></div></div></div><div class="view-switcher" style="display: none;"><select></select></div><div id="user" class="button" title="admin cloud"><div class="name">admin cloud</div><div class="icon options"><div class="icon arrow"></div></div><div id="user-options" style="display: none;"><a href="#">注销</a><a href="#" class="help">帮助</a><a href="#" class="about">关于</a></div></div></div></div>';
			
			$('#user').hide();
			
			$('.logo').remove();
			
			//var avmon ='<div id="wrap"> <div id="avmontop" class="avmontop"><div class="fixed"><a href="${avmonURL}"><div class="avmon_LOGO"></div></a><a href="${avmonURL}"><div class="Avmon_back"></div></a> <div class="MainTitle f28px LineH12" style="font-size: 18px;line-height: 12px;" >资源管理</div><div class="Profile" id="ShowUserBoxclick" style="cursor:pointer"><div class="ProfileIcon"></div><div class="ProfileName ">My Account</div><div class="ProfileArrow"></div><div class="blank0"></div></div></div><div id="ShowUserBoxMain" style="display:none"><div class="ShowUserBoxArrow"></div><div class="ShowUserBox"><ul><li><a href="#"><span class="AccountSettingIcon"></span><span>个人设置</span></a></li><li><a href="Login.html"><span class="SignOutIcon"></span><span>退出</span></a></li><div class="blank0"></div></ul></div> </div></div></div>';
			
			//var avmon ='<div id="wrap"><div id="avmontop" class="avmontop"><div class="fixed"><a href="${avmonURL}"><div class="avmon_LOGO"></div></a><a href="${avmon}"><div class="Avmon_back"></div></a><div class="MainTitle f28px LineH12"style="font-size: 18px; line-height: 12px;">资源管理</div></div></div></div>';
			//var avmon ='<div id="wrap"><div id="avmontop" class="avmontop"><div class="fixed"><a href="${web}"><div class="Avmon_back"></div></a><div id="aa" class="MainTitle f28px LineH12"style="font-size: 28px; line-height: 28px;line-height: 12px !important;">资源管理</div></div></div></div>';
			var avmon='<div id="wrap"><div id="avmontop" class="avmontop"><div class="fixed"><a href="${web}"><div class="Avmon_back"></div></a><div id="aa" class="MainTitle f28px LineH12"style="font-size: 28px;line-height: 12px !important; font-family: \'Microsoft yahei\',\'微软雅黑\',\'Lato\', Helvetica,Tahoma,Verdana,Arial,sans-serif ">资源管理</div></div></div></div>';
